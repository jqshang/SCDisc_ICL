...
python -m icl.run_reranking --dataset semeval_en --tokenizer-model bert-base-uncased --llm-model  gemma3 --llm-checkpoint google/gemma-3-4b-it --n-icl-examples 8
# python -m icl.run_reranking --dataset semeval_en --tokenizer-model bert-base-uncased --llm-model qwen --llm-checkpoint Qwen/Qwen2.5-72B-Instruct --n-icl-examples 8
